...
function BookList({
  ...
  useEffect(() => {
    ...
    if (likesSort === "htl") temp.sort((a, b) => b.likes - a.likes);
    if (likesSort === "lth") temp.sort((a, b) => a.likes - b.likes);

    if (priceSort === "htlp") temp.sort((a, b) => b.price - a.price);
    if (priceSort === "lthp") temp.sort((a, b) => a.price - b.price);
...
// ✅ PROPS VALIDATION (STRICT RULE COMPLIANCE)
BookList.propTypes = {
